...
describe("List.each", (function () {
        return Jest.test("should iterate through a list and apply the function to each item", (function () {
                      var abc = [""];
                      ReList.each((function (x) {
                              abc[0] = abc[0] + x;
                              return /* () */0;
                            }), /* :: */[
                            "a",
                      ...
                      return Curry._2(Jest.Expect[/* toEqual */11], "abc", Curry._1(Jest.Expect[/* expect */0], abc[0]));
                    }));
      }));

describe("List.find", (function () {
        Jest.test("should find an item from a list", (function () {
                return Curry._2(Jest.Expect[/* toBe */1], /* Some */[3], Curry._1(Jest.Expect[/* expect */0], ReList.find((function (x) {
                                      return +(x === 3);
                                    }), /* :: */[
                                    1,
                                    /* :: */[
        ...
        return Jest.test("should return None when item is not found", (function () {
                      return Curry._2(Jest.Expect[/* toBe */1], /* None */0, Curry._1(Jest.Expect[/* expect */0], ReList.find((function (x) {
                                            return +(x === 0);
                                          }), /* :: */[
                                          1,
                                          /* :: */[
...
describe("List.delete", (function () {
        return Jest.test("should delete the first occurance of an item in a list", (function () {
                      return Curry._2(Jest.Expect[/* toEqual */11], /* :: */[
                                  1,
                                  /* :: */[
                                    2,
                                ...
                                ], Curry._1(Jest.Expect[/* expect */0], ReList.$$delete(2, /* :: */[
                                          1,
                                          /* :: */[
                                            2,
                                            /* :: */[
